...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('adm/css/bootstrap.css')}}">
    <link rel="stylesheet" href="{{ asset('adm/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{ asset('adm/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{ asset('adm/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{ asset('adm/style.css')}}">
    <link rel="stylesheet" href="{{ asset('adm/responsive.css')}}">
</head>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <div class="contact">
                                <p><span class="phone"><a href="#">Phone: +60172271513 </a></span><span class="email"><a href="#">Email: peyatimpertubuhan@gmail.com</a></span></p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            <a href="#">
                                <div class="main-logo">
                                    ...
                                    <h2>SHARETHERIZQ:HUB FOR ORPHANAGE GIVING</h2>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="client owl-carousel owl-theme">
                            <div class="item">
                                <div class="text">
                                    ...
                                    <p>“When we give cheerfully and accept gratefully,<br> everyone is blessed"– Maya Angelou- </p>
                            ...
                            <div class="item">
                                <div class="text">
                                    <h3>CHILDREN NEED YOUR HELP</h3>
                                    <p>"We make a living by what we get, <br> we make a life by what we give"<br>- Winston Churchill-</p>
                                    <h5 class="white-button"><a href="#">DONATE NOW</a></h5>
                                    <h5><a href="#">CONTACT US</a></h5>
                                </div>
                            </div>
                            <div class="item">
                                <div class="text">
                                    <h3>CHILDREN NEED YOUR HELP</h3>
                                    <p>“The unfortunate need people who will be kind to them;<br>the prosperous need people to be kind to.” <br>-Aristotle-</p>
                                    <h5 class="white-button"><a href="#">DONATE NOW</a></h5>
                                    <h5><a href="#">CONTACT US</a></h5>
                                </div>
        </section>
